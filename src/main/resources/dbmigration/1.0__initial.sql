...
alter table exploration add constraint fk_exploration_id foreign key (id) references consultation (id) on delete restrict on update restrict;

alter table measurement add constraint fk_measurement_id foreign key (id) references consultation (id) on delete restrict on update restrict;
